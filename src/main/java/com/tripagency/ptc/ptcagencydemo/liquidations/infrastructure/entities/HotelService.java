...
@Setter
@NoArgsConstructor
public class HotelService extends BaseAbstractEntity {
    ...
    @OneToMany(mappedBy = "hotelService", cascade = CascadeType.ALL, orphanRemoval = true)
